...
const attributeAssignmentContext = require('./tokenizer-context-handlers/attribute-assignment')
...
const attributeValueWrappedStartContext = require('./tokenizer-context-handlers/attribute-value-wrapped-start')
...
const attributeValueWrappedEndContext = require('./tokenizer-context-handlers/attribute-value-wrapped-end')
...
const doctypeAttributeWrappedStartContext = require('./tokenizer-context-handlers/doctype-attribute-wrapped-start')
const doctypeAttributeWrappedContext = require('./tokenizer-context-handlers/doctype-attribute-wrapped')
const doctypeAttributeWrappedEndContext = require('./tokenizer-context-handlers/doctype-attribute-wrapped-end')
const doctypeAttributeBareEndContext = require('./tokenizer-context-handlers/doctype-attribute-bare')
const commentStartContext = require('./tokenizer-context-handlers/comment-start')
const commentContentContext = require('./tokenizer-context-handlers/comment-content')
const commentEndContext = require('./tokenizer-context-handlers/comment-end')
...
const contextHandlersMap = {
  ...
  [DOCTYPE_ATTRIBUTE_WRAPPED_START_CONTEXT]: doctypeAttributeWrappedStartContext,
  [DOCTYPE_ATTRIBUTE_WRAPPED_CONTEXT]: doctypeAttributeWrappedContext,
  [DOCTYPE_ATTRIBUTE_WRAPPED_END_CONTEXT]: doctypeAttributeWrappedEndContext,
  [DOCTYPE_ATTRIBUTE_BARE_CONTEXT]: doctypeAttributeBareEndContext,
  [COMMENT_START_CONTEXT]: commentStartContext,
  [COMMENT_CONTENT_CONTEXT]: commentContentContext,
  [COMMENT_END_CONTEXT]: commentEndContext
}
