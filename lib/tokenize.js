...
const doctypeStartContentContextFactory = require('./tokenize-contexts/doctype-start.factory')
const doctypeEndContentContextFactory = require('./tokenize-contexts/doctype-end.factory')
...
const contextFactoriesMap = {
  ...
  [DOCTYPE_START_FACTORY]: doctypeStartContentContextFactory,
  [DOCTYPE_END_FACTORY]: doctypeEndContentContextFactory
}
